...
public class StudentEndpointTest {
	...
	static class config {
		...
		public RestTemplateBuilder restTemplateBuilder() {
			return new RestTemplateBuilder().basicAuthentication("cleilton", "cleilton");
		}
	}

	@Before
	public void setup() {
		Student student = new Student(1L, "Bilbo", "Bilbo@OHobbit.com");
	...
	public void listStudentsWhenUsernameAndPasswordAreCorrectShouldReturnStatusCode200() {
		List<Student> students = Arrays.asList(new Student(1L, "Bilbo", "Bilbo@OHobbit.com"),
				new Student(2L, "Thorin", "escudodecarvalho@OHobbit.com"));
	...
	public void getStudentsByIdWhenUsernameAndPasswordAreCorrectAndStudentDoesNotExistShouldReturnStatusCode404() {
		ResponseEntity<String> response = restTemplate.getForEntity("/v1/protected/students/{id}", String.class, 2L);
...
//		Assertions.assertThat(exchange.getStatusCodeValue()).isEqualTo(404);
	...
	public void createWhenNameIsNullShouldReturnStatusCode400BadRequest() {
		Student student = new Student(3L, null, "Gandalf@OHobbit.com");
	...
	public void createShouldPersistDataAndReturnStatusCode201() {
		Student student = new Student(3L, "Gandalf", "Gandalf@OHobbit.com");
		BDDMockito.when(studentRepository.save(student)).thenReturn(student);
